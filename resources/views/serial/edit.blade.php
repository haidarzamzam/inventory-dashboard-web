        ...
        <div class="pt-5">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-red-400 border border-red-500 p-3 sm:rounded-lg">
                    <span class="text-white">Edit nomor seri gagal, pastikan data sesuai!</span>
                </div>
            </div>
        </div>
    @endif
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="py-12 px-48 text-gray-900">
                    <form action="{{ route('serial.update', ['product_id' => $product_id, 'serial' => $serial->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="serial_no" id="serial_no" placeholder="Masukkan nomor seri"
                                ...
                                value="{{ old('serial_no', $serial->serial_no) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="price" id="price" placeholder="Masukkan harga"
                                ...
                                value="{{ old('price', $serial->price) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="prod_date" id="prod_date" placeholder="Masukkan nama merek"
                                ...
                                value="{{ old('prod_date', $serial->prod_date) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="warranty_start" id="warranty_start" placeholder="Masukkan nomor model"
                                ...
                                value="{{ old('warranty_start', $serial->warranty_start) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            class="form-input block w-full rounded mt-1 @error('warranty_duration') border border-red-500 @enderror"
                                value="{{ old('warranty_duration', $serial->warranty_duration) }}" required>
